# Crypto Landing page (UI only)

A landing page for crypto trading company to improve CSS skills. All the elements are placed using the position property.
...
| Color | Hex                                                              |
| ----- | ---------------------------------------------------------------- |
| Pink  | ![#b92284](https://via.placeholder.com/10/b92284?text=+) #b92284 |
